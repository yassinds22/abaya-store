...
?>
        ...
        <div class="hero-slider">
            ...
            <div class="slide active" style="background-image: url('assets/images/hero-banner.jpg');">
                <div class="hero-content">
                    ...
                    <div class="hero-buttons">
                        <a href="products" class="btn btn-primary">تسوقي الآن <i class="fas fa-shopping-bag"></i></a>
                        <a href="about" class="btn btn-secondary">اكتشفي المحل</a>
                    </div>
                </div>
            </div>
            <!-- الشريحة الثانية -->
            <div class="slide" style="background-image: url('assets/images/logo.png');">
                <div class="hero-content">
                    ...
                    <div class="hero-buttons">
                        <a href="products" class="btn btn-primary">رؤية العبايات <i class="fas fa-arrow-left"></i></a>
    ...
    <section class="section" id="latest-arrivals-section">
        ...
        <div style="text-align: center; margin-top: 50px;">
            <a href="products" class="btn btn-primary" style="padding: 15px 40px;">مشاهدة كل المنتجات <i class="fas fa-arrow-left"></i></a>
        </div>
    </section>

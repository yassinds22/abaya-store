...
<head>
    ...
    <title>اتصلي بنا | لارين عباية</title>
    <meta name="description" content="تواصل معنا للاستفسار أو طلبات العبايات المخصصة. انسخي رقم الهاتف للتواصل المباشر، أو راسلينا عبر واتساب.">
...
<body>
    ...
    <script>
        ...
        // معالجة إرسال النموذج المخصص للتواصل
